    ...
    return (
        <div>
            ...
            <div className='flex border rounded-t-lg gap-2 p-4 items-center'>
                <p className='bg-slate-100 rounded-full p-2'><GrFacebookOption className='text-blue-800 w-5 h-5'></GrFacebookOption></p>
                <p>FaceBook</p>
            </div>
            <div className='flex border-x gap-2 p-4 items-center'>
                <p className='bg-slate-100 rounded-full p-2'><AiOutlineTwitter className='text-blue-400 w-5 h-5'></AiOutlineTwitter></p>
                <p>Twitter</p>
            </div>
            <div className='flex border rounded-b-lg gap-2 p-4 items-center'>
                <p className='bg-slate-100 rounded-full p-2'><AiOutlineInstagram className='text-rose-500 w-5 h-5'></AiOutlineInstagram></p>
                <p>Instagram</p>
            </div>
        </div>
    );
